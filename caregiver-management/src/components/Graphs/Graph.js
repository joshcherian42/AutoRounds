...
function Graph({ scale, metric, health_data, syncDate, prescription_data }) {
    ...
    useEffect(() => {
        ...
        if (metric === "Dressing" || metric === "Showering/Bathing") {
            setDressingWeekDate(
                new Date(
                    health_data.current[health_data.current.length - 1][
                        "timestamp"
                    ]
                )
            );
            ...
            <div>
                ...
                <div>
                    {week_data.map(function (w) {
                        ...
                        let week_date_string = week_date.toLocaleString(
                            "en-US",
                            {
                                month: "short",
                                day: "numeric",
    ...
    function boolean_week(health_data) {
        ...
        let month = new Date(week_data[0][0].timestamp).toLocaleString(
            "en-US",
            {
                month: "long",
                year: "numeric",
                    ...
                    <div className="mantine-1kjbdzr mantine-Calendar-calendarHeader">
                        <button
                            ...
                            onClick={() =>
                                setDressingWeekDate(
                                    new Date(
                                        dressingWeekDate.setDate(
                                            dressingWeekDate.getDate() - 7
                                        )
                                    )
                                )
                            }
                        ...
                        <tbody>
                            <tr>
                                {week_data.map(function (w, i) {
                                    let week_date = new Date(w[0].timestamp);
                                    let week_date_string =
                                        week_date.toLocaleString("en-US", {
                                            day: "numeric",
                                        });
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="calendar_day">
                                                    ...
                                                    >
                                                        {w.map(function (d, i) {
                                                            return get_with_assistance_check(
                                                                d,
                                                                i
                                                            );
                                                        })}
                    ...
                    <div className="med_check">
                        {day_values.length !== 0 && (
                            <div>
                                ...
                                {prescription_data.current.map(function (
                                    el,
                                    i
                                ) {
            ...
            if (typeof day_values[0] !== "undefined") {
                return (
                    <div className="calendar_day">
                        ...
                        >
                            {day_values.map((el, i) =>
                                get_with_assistance_check(el, i)
                            )}
                        </div>
                    </div>
                );
